...
function getSantasNaughtyListFunctional(people, habit) {
    const naughtyList = people.filter(person => person.habits.includes(habit));
    return naughtyList.map(person => person.firstName + " " + person.lastName);
}
